...
def constructBuilding(ikariam_service, db, telegram):
    ...
    # get a list of all the possible buildings that can be built
    buildings = []
    ...
    for type_space in type_spaces:
        ...
        if len(free_spaces_of_type) > 0:
            ...
            buildings_response = ikariam_service.post(params=params, noIndex=True)
    ...
    # show possible positions for the selected building
